          ...
          child: Padding(
            ...
            child:
              ...
              Obx(() {
                ...
                ElevatedButton(
                  onPressed: () async {
                    await _authenticationController.register(email: _emailController.text.trim(), password: _passwordController.text.trim(), name: _nameController.text.trim(), dni: _dniController.text.trim());
                  },
